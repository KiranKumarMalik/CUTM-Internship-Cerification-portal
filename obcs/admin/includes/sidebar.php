...
{               ?>
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Internship Certificates</span> <span class="indicator-right-menu mini-dn">&nbsp;<i class="fa indicator-mn fa-angle-right"></i></span></a>
