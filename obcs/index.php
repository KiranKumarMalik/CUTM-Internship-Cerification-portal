...
<body>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php"><img src="./img/cutm_logo.png" alt="Logo" width="60" height="75"></a>
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/poster.jpg);">
            ...
            <div class="container h-100">
                <div class="row h-100">
                    <div class="col-12 h-100">
                        ...
                        Reserved. Designed by <i class="fa fa-heart" style="font-size:25px;color:red"></i>&nbsp<b>Kiran Kumar Malik</b> </a></p>
                            </div>
                            <!-- Footer Nav -->
                                    
                                        <li style="color: white;">Centurion University of Technology and Management</li>
                        </div>
                    </div>
                </div>
            </div>
